...
class VGG19(nn.Module):
    def __init__(self, requires_grad=False):
        ...
        self.slice3_1 = nn.Sequential()
        self.slice3_2 = nn.Sequential()
        self.slice4_1 = nn.Sequential()
        self.slice4_2 = nn.Sequential()
    ...
    def forward(self, X):
        ...
        vgg_outputs = namedtuple(
            "VggOutputs", ['relu1_2', 'relu2_2',
                           'relu3_2', 'relu3_4', 'relu4_2', 'relu4_4', 'relu5_4'])
        out = vgg_outputs(h_relu1_2, h_relu2_2, h_relu3_2,
                          h_relu3_4, h_relu4_2, h_relu4_4, h_relu5_4)
