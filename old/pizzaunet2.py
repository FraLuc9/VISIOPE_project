...
class OliveOil(nn.Module):
    def __init__(self):
        ...
        self.conv51 = nn.Conv2d(525, 1024, 3, 1, 1)
        self.conv52 = nn.Conv2d(1037, 512, 3, 1, 1)
...
if __name__ == '__main__':
    ...
    epochs = 50
    writer = SummaryWriter(log_dir="plots/unetRefinedDatasetLoss/")
    for epoch in range(epochs):
        ...
        torch.save(state, "latest_unet.pth")
        if test_epoch_loss < best_loss:
            best_loss = test_epoch_loss
            torch.save(state, "best_unet.pth")
